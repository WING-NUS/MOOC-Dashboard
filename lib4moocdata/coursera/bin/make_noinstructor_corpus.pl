...
my $createtable1		= undef;
my $createtable2		= undef;
my $createtable3		= undef;
my $createtable4		= undef;
my $posttable 			= undef;
...
if($threadtype eq 'inst'){
	...
	# my $createtable1 = "create table if not exists $posttable";
	# my $createtable1 = 'create table post2';
	# my $createtable2 = 'create table comment2';
}
elsif($threadtype eq 'nota'){
	$posttable = 'post3';
	$commenttable = 'comment3';
	# my $createtable3 = 'create table post3';
	# my $createtable4 = 'create table comment3';
}
...
my $notathreadqry = "select distinct threadid from user_new u
							where u.courseid = ?
									and u.forumid = ?
									and u.user_title in (\"Instructor\", \"Staff\")";
